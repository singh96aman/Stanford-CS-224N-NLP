...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for partial_parses, transition in zip(mini_batch, transitions):
            partial_parses.parse_step(transition)
            if not partial_parses.buffer and len(partial_parses.stack) == 1:
                unfinished_parses.remove(partial_parses)
