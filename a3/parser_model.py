...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        #print(w.shape, w.size()[0])
        #print(self.n_features, self.embed_size, self.hidden_size, self.embeddings.size())
    ...
    def forward(self, w):
        ...
        #print( (self.embed_to_hidden_weight + self.embed_to_hidden_bias).size(), x.size() )
        x = F.relu(x)
        x = self.dropout(x)
